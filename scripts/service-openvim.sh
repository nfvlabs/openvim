...
#launch openvim and/or floodlight inside a screen. It assumes a relative path .. for openvim and ../../floodlight-0.90 for floodlight
...
function usage(){
    echo -e "Usage: $0 [floodlight/flow] [openvim/vim] start|stop|restart|status"
    echo -e "  Launch|Removes|Restart|Getstatus openvim|floodlight (by default all) on a screen"
...
do
    ...
    [ "$param" == "openmano" -o "$param" == "mano" ]   && continue
